<span class="cs-page-kicker">Extras</span>
...
![Original Bazz Fuss circuit](../assets/images/perf-vero/211c174b-fd94-42dd-b0be-9112ccc89f0e.png)
/// caption
Original Bazz Fuss circuit found on the Homewrecker site
///

![Breadboarded circuit](../assets/images/perf-vero/31c3ab60-f5a0-4d41-92c9-cb4e6a9d0b6d.png)
/// caption
Bazz Fuss circuit post-breadboarding, with notes
///
...
![New DIYLC project](../assets/images/perf-vero/diylc-new-project.png)
/// caption
Opening a new project in DIYLC
///

![DIYLC schematic](../assets/images/perf-vero/dea37ff4-d1f0-4086-a400-50fce6866839.png)
/// caption
Bazz Fuss schematic after I've drawn it up in DIYLC
///
...
![Wire pads laid out](../assets/images/perf-vero/64f0719b-a8f8-4c49-afc1-a1a5493c146b.png)
/// caption
The perf board with wire pads laid out
///
...
![Major components placed](../assets/images/perf-vero/06bd1caa-d7e4-4372-bfcf-4f43bfc0e7fd.png)
/// caption
Adding larger and more critical components to the layout
///
...
![Pots soldered to board](../assets/images/perf-vero/75d74289-909e-4077-8507-734d08586f9c.jpg)
/// caption
Pots are soldered directly onto the board in this layout.
///
...
![Capacitors on the layout](../assets/images/perf-vero/897d1556-3ed8-42b9-8cf8-eeb9193a9a14.jpg)
/// caption
Note that some of those green mylar film capacitors are pretty big.
///
...
![Standing resistors](../assets/images/perf-vero/a28f7171-bbcf-450f-8b73-43c653883e03.jpg)
/// caption
Note the standing resistors on this layout.
///
...
![Finished layout](../assets/images/perf-vero/bazz-fuss-finished-layout.png)
/// caption
The finished perf board layout
///
...
![Solder-side layout](../assets/images/perf-vero/f30d27ce-fe8b-4bb5-9b0b-7f4cb261e7c0.png)
/// caption
The finished layout with solder-side mirrored on the right.
///
